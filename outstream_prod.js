(function () {
    ...
    ***************************************************************************** */
    ...
    const getWitdhAndHeight = (props) => {
        var _a;
        const width = ((_a = props.parentNode) === null || _a === void 0 ? void 0 : _a.offsetWidth) || 0;
    ...
    const isVideoMimeType = (chekingType) => videoMimeTypes.some((type) => type === chekingType);
    const configCreativesForVideo = (mediaFiles, MEDIA_QUERYS) => {
        if ((mediaFiles === null || mediaFiles === void 0 ? void 0 : mediaFiles.length) === 1 &&
        ...
        const sortedMedia = mediaFiles === null || mediaFiles === void 0 ? void 0 : mediaFiles.sort((a, b) => {
            return a.width < b.width ? -1 : 1;
        });
        return sortedMedia === null || sortedMedia === void 0 ? void 0 : sortedMedia.reduce((creatives, creative, index) => {
      ...
      ad.creatives.forEach(function (wrapperCreativeElement) {
        if (["linear", "nonlinear"].indexOf(wrapperCreativeElement.type) !== -1) {
          ...
          if (wrapperCreativeElement.videoClickTrackingURLTemplates) {
            ...
            wrapperCreativeElement.videoClickTrackingURLTemplates.forEach(function (
              item
            ) {
    ...
    */
          ...
          value: function resolveWrappers(ad, wrapperDepth, previousUrl) {
            ...
            return new Promise(function (resolve) {
              ...
              var allowMultipleAds =
                (_this7$parsingOptions = _this7.parsingOptions.allowMultipleAds) !==
                  null && _this7$parsingOptions !== void 0
    ...
    const setCurrentAds = (props) => {
        ...
        currentAds.ads.errorURLTemplates = decodeURLs(currentAds.ads.errorURLTemplates);
        currentAds.containVPAID = currentAds.ads.creatives[0].mediaFiles.some(VPAIDCondition);
        currentAds.tracker = new VASTTracker(props.vastClient, currentAds.ads, currentAds.ads.creatives[0]);
        currentAds.vastClient = props.vastClient;
        return currentAds;
    };

    const getNextAds = (vastClient) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "d", "M9.47,8,15.7,1.77A1.05,1.05,0,0,0,15.7.3a1.05,1.05,0,0,0-1.47,0L8,6.53,1.77.3A1.05,1.05,0,0,0,.3.3a1.05,1.05,0,0,0,0,1.47L6.53,8,.3,14.23a1.05,1.05,0,0,0,0,1.47A1.06,1.06,0,0,0,1,16a1,1,0,0,0,.73-.3L8,9.47l6.23,6.23A1,1,0,0,0,15,16a1.06,1.06,0,0,0,.74-.3,1.05,1.05,0,0,0,0-1.47Z");
    			...
    			set_style(button, "margin", /*floating_css*/ ctx[1] ? '8px 0 8px 8px' : '0 8px');
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Icon_close> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('onClick' in $$props) $$invalidate(0, onClick = $$props.onClick);
    		if ('floating_css' in $$props) $$invalidate(1, floating_css = $$props.floating_css);
    	};
    ...
    class Icon_close extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { onClick: 0, floating_css: 1 }, add_css$4);
    	...
    	get onClick() {
    		throw new Error("<Icon_close>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set onClick(value) {
    		throw new Error("<Icon_close>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			g0 = svg_element("g");
    			path = svg_element("path");
    			attr_dev(path, "d", "M30.67,0A23.36,23.36,0,0,0,7.34,23.33v.08L2.73,16.46A1.48,1.48,0,0,0,.67,16,1.47,1.47,0,0,0,.25,18.1L7,28.18A1.45,1.45,0,0,0,8,28.83h.18a1.49,1.49,0,0,0,1-.38l9.31-8.39a1.49,1.49,0,1,0-2-2.21l-6.18,5.58v-.11a20.37,20.37,0,1,1,6,14.4,1.48,1.48,0,0,0-2.1,2.1A23.33,23.33,0,1,0,30.67,0Z");
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Icon_reinit> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('reinitButton' in $$props) $$invalidate(0, reinitButton = $$props.reinitButton);
    	};
    ...
    class Icon_reinit extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { onClick: 1, reinitButton: 0 }, add_css$3);
    	...
    	get onClick() {
    		throw new Error("<Icon_reinit>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set onClick(value) {
    		throw new Error("<Icon_reinit>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    const getStyleVar = (config) => {
        ...
        switch (config.skin) {
            case "dark":
                return Object.assign(Object.assign({}, configVars), { "color--icon": "rgb(236, 236, 236)", "color--add": "#fff", "collor--bg": "rgba(0, 0, 0, 0.53);", "color--stroke": "#fff" });
            case "white":
                return Object.assign(Object.assign({}, configVars), { "color--icon": "rgb(46, 46, 46)", "color--add": "rgb(109, 109, 109)", "collor--bg": "rgb(236, 236, 236)", "color--stroke": "#000" });
            default:
                return Object.assign(Object.assign({}, configVars), { "color--icon": "rgb(236, 236, 236)", "color--add": "#fff", "collor--bg": "rgba(0, 0, 0, 0.53);", "color--stroke": "#fff" });
        }
    };
    ...
    const replaceMacro = (vastClient, widthAndHeight) => {
        ...
        vastParser.addURLTemplateFilter((vastUrl) => {
            return vastUrl
                ...
                .replace("%5Brandom%5D", `${Math.floor(Math.random() * (100000000 - 1) + 1)}`);
        });
    };

    const fetchVast = (props) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const TEST_BUILD_URL = "https://vst.dfn-network.pro";
    const PROD_BUILD_URL = "https://vst.dfn-network.pro";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(source.src, source_src_value = /*source*/ ctx[20].src)) attr_dev(source, "src", source_src_value);
    			attr_dev(source, "type", source_type_value = /*source*/ ctx[20].type);

    			attr_dev(source, "media", source_media_value = navigator.userAgent.search(/Edge/) > 0
    			? ''
    			: /*source*/ ctx[20].media);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*props*/ 1 && !src_url_equal(source.src, source_src_value = /*source*/ ctx[20].src)) {
    				attr_dev(source, "src", source_src_value);
    			}

    			if (dirty & /*props*/ 1 && source_type_value !== (source_type_value = /*source*/ ctx[20].type)) {
    				attr_dev(source, "type", source_type_value);
    			}

    			if (dirty & /*props*/ 1 && source_media_value !== (source_media_value = navigator.userAgent.search(/Edge/) > 0
    			? ''
    			: /*source*/ ctx[20].media)) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(video, "poster", "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH/C05FVFNDQVBFMi4wAwEAAAAh+QQEAAAAACwAAAAAAQABAAACAkQBADs=");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window_1, "scroll", /*setVideoHeightAndPlayPause*/ ctx[13], false, false, false),
    					listen_dev(window_1, "resize", /*setVideoHeightAndPlayPause*/ ctx[13], false, false, false),
    					listen_dev(video, "canplay", /*loaded*/ ctx[11], false, false, false),
    					listen_dev(video, "play", /*playAction*/ ctx[5], false, false, false),
    					listen_dev(video, "play", /*playActionOnce*/ ctx[4], { once: true }, false, false),
    					listen_dev(video, "pause", /*pauseAction*/ ctx[7], false, false, false),
    					listen_dev(video, "error", /*errorAction*/ ctx[6], false, false, false),
    					listen_dev(video, "click", /*clickAction*/ ctx[10], false, false, false),
    					listen_dev(video, "volumechange", /*volumeAction*/ ctx[9], false, false, false),
    					listen_dev(video, "timeupdate", video_timeupdate_handler),
    					listen_dev(video, "mouseover", /*otherAdInteraction*/ ctx[12], false, false, false),
    					listen_dev(video, "ended", /*endedAction*/ ctx[8], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*props*/ 1 && video_muted_value !== (video_muted_value = /*props*/ ctx[0].isMuted)) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, videoStore, $$value => $$invalidate(2, $videoStore = $$value));
    	validate_store(compliteStore, 'compliteStore');
    	component_subscribe($$self, compliteStore, $$value => $$invalidate(17, $compliteStore = $$value));
    	validate_store(duration, 'duration');
    	component_subscribe($$self, duration, $$value => $$invalidate(18, $duration = $$value));
    	...
    	const errorAction = error => {
    		if (error instanceof Error) {
    			log(`Error in source video - ${(error === null || error === void 0
			? void 0
			: error.message) || error}`);
    		}
    	...
    	const clickAction = () => {
    		...
    		props.currentAds.tracker.click((_b = (_a = props.currentAds.ads.creatives[0]) === null || _a === void 0
    		? void 0
    	...
    	onDestroy(() => {
    		...
    		(_a = $videoStore.querySelector("source:last-child")) === null || _a === void 0
    		? void 0
    	...
    	const setVideoHeightAndPlayPause = () => {
    		$$invalidate(1, videoHeight = `${getWitdhAndHeight({
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('unsubscribeTimeUp' in $$props) unsubscribeTimeUp = $$props.unsubscribeTimeUp;
    ...
    class Video extends SvelteComponentDev {
    	...
    	get props() {
    		throw new Error_1("<Video>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set props(value) {
    		throw new Error_1("<Video>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    const createFrameScript = (currentAds, cssId) => {
        var _a, _b;
        return `<head><style>body{margin:0}</style></head><body><script type="text/javascript" id="${cssId}"  charset="UTF-8" src="${(_b = (_a = currentAds.ads.creatives[0]) === null || _a === void 0 ? void 0 : _a.mediaFiles[0]) === null || _b === void 0 ? void 0 : _b.fileURL}" async></script></body>`;
    };
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function onLoad() {
    		...
    		adUnit = (_a = iframeVpaid.contentWindow) === null || _a === void 0
    		? void 0
    		: _a.getVPAIDAd();
    	...
    	onMount(() => __awaiter(void 0, void 0, void 0, function* () {
    		...
    		? void 0
    		: frameContext.document.write(createFrameScript(props.currentAds, cssId));

    		const script = frameContext === null || frameContext === void 0
    		? void 0
    		...
    		script === null || script === void 0
    		? void 0
    		: script.addEventListener("error", () => errorStore.set(new ReinitError(errorCodesVAST["Can't load VPAID"])));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Vpaid> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('props' in $$props) $$invalidate(1, props = $$props.props);
    		if ('iframeVpaid' in $$props) $$invalidate(0, iframeVpaid = $$props.iframeVpaid);
    		if ('events' in $$props) events = $$props.events;
    		if ('adUnit' in $$props) adUnit = $$props.adUnit;
    		if ('observerVpaidUnsub' in $$props) observerVpaidUnsub = $$props.observerVpaidUnsub;
    ...
    class Vpaid extends SvelteComponentDev {
    	...
    	get props() {
    		throw new Error("<Vpaid>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set props(value) {
    		throw new Error("<Vpaid>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_if_block(ctx) {
    	...
    	binding_callbacks.push(() => bind(iconreinit, 'reinitButton', iconreinit_reinitButton_binding));
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			if_block2.c();
    			attr_dev(div, "class", div_class_value = "" + (null_to_empty(/*isFlyyingMode*/ ctx[10] ? 'df__fly' : 'df') + " svelte-1y4c37f"));
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*isMuted, config, reinitButton, currentAds*/ 99) video_changes.props = {
    				isMuted: /*isMuted*/ ctx[5],
    				videoSources: /*videoSources*/ ctx[14],
    				looped: String(/*config*/ ctx[0].looped),
    				reinitButton: /*reinitButton*/ ctx[6],
    			...
    			if (!current || dirty[0] & /*isFlyyingMode*/ 1024 && div_class_value !== (div_class_value = "" + (null_to_empty(/*isFlyyingMode*/ ctx[10] ? 'df__fly' : 'df') + " svelte-1y4c37f"))) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div4, "top", (/*isShortHeader*/ ctx[16] ? '-35' : '-60') + "px");
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*wrapper*/ 128) iconclose_changes.onClick = /*func*/ ctx[23];
    ...
    function create_if_block_4(ctx) {
    	...
    	let iconclose;
    	let current;
    	let if_block0 = /*creative*/ ctx[13]?.icons[0]?.staticResource && create_if_block_6(ctx);
    	let if_block1 = /*currentAds*/ ctx[1].ads.description && create_if_block_5(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*creative*/ ctx[13]?.icons[0]?.staticResource) if_block0.p(ctx, dirty);
    			...
    			const iconclose_changes = {};
    			if (dirty[0] & /*wrapper*/ 128) iconclose_changes.onClick = /*func_1*/ ctx[24];
    			iconclose.$set(iconclose_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img.src, img_src_value = /*creative*/ ctx[13]?.icons[0]?.staticResource)) attr_dev(img, "src", img_src_value);
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*currentAds*/ 2 && t_value !== (t_value = /*currentAds*/ ctx[1].ads.description + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const iconclose_changes = {};
    			if (dirty[0] & /*config*/ 1) iconclose_changes.onClick = /*func_2*/ ctx[25];
    			iconclose.$set(iconclose_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*isMuted, reinitButton, currentAds, config, widthAndHeight, $videoStore, wrapper, container*/ 4335) vpaid_changes.props = {
    				isMuted: /*isMuted*/ ctx[5],
    				reinitButton: /*reinitButton*/ ctx[6],
    				currentAds: /*currentAds*/ ctx[1],
    				config: /*config*/ ctx[0],
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "d", "M8,21 L12,21 L17,26 L17,10 L12,15 L8,15 L8,21 Z M19,14 L19,22 C20.48,21.32 21.5,19.77 21.5,18 C21.5,16.26 20.48,14.74 19,14 ZM19,11.29 C21.89,12.15 24,14.83 24,18 C24,21.17 21.89,23.85 19,24.71 L19,26.77 C23.01,25.86 26,22.28 26,18 C26,13.72 23.01,10.14 19,9.23 L19,11.29 Z");
    			add_location(path0, file, 203, 14, 7491);
    			attr_dev(path1, "class", path1_class_value = "" + (null_to_empty(/*isMuted*/ ctx[5] ? 'df-svg-hider' : '') + " svelte-1y4c37f"));
    			...
    			attr_dev(button, "class", button_class_value = "df--controls--mute--button " + (/*isMuted*/ ctx[5]
    			? 'df--controls--mute--button__mute'
    			: '') + " svelte-1y4c37f");
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*isMuted*/ 32 && path1_class_value !== (path1_class_value = "" + (null_to_empty(/*isMuted*/ ctx[5] ? 'df-svg-hider' : '') + " svelte-1y4c37f"))) {
    				attr_dev(path1, "class", path1_class_value);
    			}

    			if (dirty[0] & /*isMuted*/ 32 && button_class_value !== (button_class_value = "df--controls--mute--button " + (/*isMuted*/ ctx[5]
    			? 'df--controls--mute--button__mute'
    			: '') + " svelte-1y4c37f")) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "style", div_style_value = "" + (/*cssVarStyles*/ ctx[11] + "; height: " + /*widthAndHeight*/ ctx[2][1] + "px;"));
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window, "scroll", /*scroll_handler*/ ctx[21], false, false, false),
    					listen_dev(window, "resize", /*resize_handler*/ ctx[22], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*cssVarStyles, widthAndHeight*/ 2052 && div_style_value !== (div_style_value = "" + (/*cssVarStyles*/ ctx[11] + "; height: " + /*widthAndHeight*/ ctx[2][1] + "px;"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, impressionStore, $$value => $$invalidate(19, $impressionStore = $$value));
    	validate_store(compliteStore, 'compliteStore');
    	component_subscribe($$self, compliteStore, $$value => $$invalidate(20, $compliteStore = $$value));
    	validate_store(duration, 'duration');
    	component_subscribe($$self, duration, $$value => $$invalidate(30, $duration = $$value));
    	validate_store(videoStore, 'videoStore');
    	component_subscribe($$self, videoStore, $$value => $$invalidate(12, $videoStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const videoSources = configCreativesForVideo(creative.mediaFiles, config.media_querys);
    	...
    	let isShortHeader = !((_a = creative === null || creative === void 0
    	? void 0
    	...
    	const reinitAction = () => {
    		...
    		retryStore.update(value => {
    			...
    			if (newValue > parseInt(String(config.retrays))) {
    				...
    				errorStore.set(new TerminateError(errorCodesVAST["VAST retry limit"]));
    			} else {
    	...
    	errorStore.subscribe(error => __awaiter(void 0, void 0, void 0, function* () {
    		var _b;
    		...
    		const errorCode = parseInt(error === null || error === void 0
    		? void 0
    		: error.message) > 900
    		? error === null || error === void 0
    			? void 0
    			: error.message
    		: errorCodesVAST[error === null || error === void 0
    			? void 0
    			: error.message] || "900";

    		const trackError = () => {
    			currentAds.tracker.errorWithCode(errorCode, parseInt(errorCode) > 901 ? true : false);
    		};

    		switch (error === null || error === void 0
    		? void 0
    		: error.toString()) {
    	...
    	const writable_props = ['widthAndHeight', 'config', 'currentAds', 'url', 'container'];
    	...
    	$$self.$$set = $$props => {
    		if ('widthAndHeight' in $$props) $$invalidate(2, widthAndHeight = $$props.widthAndHeight);
    		if ('config' in $$props) $$invalidate(0, config = $$props.config);
    		if ('currentAds' in $$props) $$invalidate(1, currentAds = $$props.currentAds);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('reinitButton' in $$props) $$invalidate(6, reinitButton = $$props.reinitButton);
    		if ('wrapper' in $$props) $$invalidate(7, wrapper = $$props.wrapper);
    		if ('isDisplayPlayer' in $$props) $$invalidate(8, isDisplayPlayer = $$props.isDisplayPlayer);
    		if ('progressWidth' in $$props) $$invalidate(9, progressWidth = $$props.progressWidth);
    		if ('isShortHeader' in $$props) $$invalidate(16, isShortHeader = $$props.isShortHeader);
    		if ('isFlying' in $$props) $$invalidate(4, isFlying = $$props.isFlying);
    		if ('isFlyyingMode' in $$props) $$invalidate(10, isFlyyingMode = $$props.isFlyyingMode);
    		if ('cssVarStyles' in $$props) $$invalidate(11, cssVarStyles = $$props.cssVarStyles);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*config, isFlying, $compliteStore, $impressionStore*/ 1572881) {
    			$$invalidate(10, isFlyyingMode = config.fly && isFlying && !$compliteStore && $impressionStore);
    		}
    	};

    	$$invalidate(11, cssVarStyles = Object.entries(styles).map(([key, value]) => `--${key}:${value}`).join(";"));
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*widthAndHeight*/ ctx[2] === undefined && !('widthAndHeight' in props)) {
    			console_1.warn("<App> was created without expected prop 'widthAndHeight'");
    		}
    ...
    const selectNetwork = (config) => {
        ...
        return config.link || config.test === "true"
            ? `${TEST_BUILD_URL}/${config.sourceId}${config.subId === "" ? "" : "?subid=" + config.subId}`
            : `${PROD_BUILD_URL}/${config.sourceId}${config.subId === "" ? "" : "?subid=" + config.subId}`;
    };

    const containers = document.querySelectorAll(`.${PLAYER_CLASS}`);
    const initPlayers = () => __awaiter(void 0, void 0, void 0, function* () {
        for (const container of Array.from(containers)) {
            const set = container.dataset;
            const config = {
                media_querys: (set.media_querys ||
                    MEDIA_QUERYS),
            ...
            const initPlayerInstans = (currentRetray) => __awaiter(void 0, void 0, void 0, function* () {
                if (currentRetray > parseInt(String(config.retrays)))
                    return;
                ...
                try {
                    ...
                    const mutateConfig = Object.assign(Object.assign({}, config), { retrays: parseInt(String(config.retrays)) - currentRetray });
                    new App({
                        target: container,
                        props: {
                            config: mutateConfig,
